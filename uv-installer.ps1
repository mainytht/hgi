...
The installer for uv 0.9.27

.DESCRIPTION

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/astral-sh/uv/releases/download/0.9.27
...
param (
    ...
    [string]$ArtifactDownloadUrl = 'https://github.com/astral-sh/uv/releases/download/0.9.27',
...
if ($env:UV_DOWNLOAD_URL) {
  ...
  $ArtifactDownloadUrl = "$installer_base_url/astral-sh/uv/releases/download/0.9.27"
}
$auth_token = $env:UV_GITHUB_TOKEN

$receipt = @"
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.30.2"},"source":{"app_name":"uv","name":"uv","owner":"astral-sh","release_type":"github"},"version":"0.9.27"}
"@
